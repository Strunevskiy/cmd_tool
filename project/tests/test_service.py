...
import pytest
from project.src.base.entity import ReportRecord, Order, User, Item, POSITION, TYPE
from project.src.service import ConsoleExporter, DaoManager, OrderService, ReportService, ServiceError
...
class TestOrderService(object):
    ...
    def test_order_service_save_invalid_order(self, order_service, invalid_order):
        with pytest.raises(ServiceError, message='Expect AttributeError if order passed to service is without items'):
